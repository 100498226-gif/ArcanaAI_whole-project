# Team Meeting Notes — November 19, 2024
...
1. Sprint review — Project X status
2. Client Y — Deliverable 1 update
3. Pricing model review (Sara)
...
## 3. Pricing Model Review

Sara presented a revised pricing model for the SME tier. Key change: moving from per-seat to usage-based pricing for accounts under 20 seats. Sara to share updated model with the team by end of week for final input before presenting to stakeholders.
...
Laura asked about the Christmas team dinner — poll to be shared in Slack this week. Likely date: December 19.
...
- UAT delivery for Project X: March 14, 2025 (at risk if OAuth not resolved by Nov 25)
- SME pricing model moving to usage-based — Sara to finalise model this week

---

## Next Meeting

**Tuesday, November 26, 2024 — 10:00**  
Standing agenda: sprint review + action item follow-up
